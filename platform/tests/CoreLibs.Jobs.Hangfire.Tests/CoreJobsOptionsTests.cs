...
public class CoreJobsOptionsTests
{
    ...
    {
        var options = new CoreJobsOptions { MaxRetries = 11 };
        ...
        Assert.False(valid);
        Assert.Contains(results, r => r.MemberNames.Contains(nameof(CoreJobsOptions.MaxRetries)));
    }

    [Fact]
    public void MaxRetries_AtBoundary_Zero_PassesValidation()
    {
        var options = new CoreJobsOptions { MaxRetries = 0 };
        var ctx = new ValidationContext(options);
        var results = new List<ValidationResult>();
    ...
    {
        var options = new CoreJobsOptions { DefaultTimeoutSeconds = 0 };
        var ctx = new ValidationContext(options);
        var results = new List<ValidationResult>();
        ...
        Assert.False(valid);
        Assert.Contains(results, r => r.MemberNames.Contains(nameof(CoreJobsOptions.DefaultTimeoutSeconds)));
    }

    [Fact]
    public void DefaultTimeoutSeconds_AtBoundary_Min_PassesValidation()
    {
        var options = new CoreJobsOptions { DefaultTimeoutSeconds = 1 };
        var ctx = new ValidationContext(options);
        var results = new List<ValidationResult>();
    ...
    {
        var options = new CoreJobsOptions { DefaultTimeoutSeconds = 3600 };
        var ctx = new ValidationContext(options);
        var results = new List<ValidationResult>();
