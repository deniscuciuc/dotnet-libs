...
| Library | Purpose |
|---|---|
| `CoreLibs.MQ` | Async message bus — RabbitMQ via MassTransit |
| `CoreLibs.CQRS` | In-process commands/queries — MediatR + FluentValidation + ErrorOr |

---

## CoreLibs.MQ — Message Queue
...
## CoreLibs.CQRS — Commands & Queries
