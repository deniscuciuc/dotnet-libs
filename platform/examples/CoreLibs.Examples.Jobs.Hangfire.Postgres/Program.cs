...
using CoreLibs.Examples.Jobs.Hangfire.Postgres;
...
builder.Host.UseCoreSerilog(o =>
{
    ...
    o.ApplicationName = "CoreLibs.Examples.Jobs.Hangfire.Postgres";
});
...
{
    c.SwaggerDoc("v1", new() { Title = "CoreLibs Jobs — Hangfire + Postgres", Version = "v1" });
});
