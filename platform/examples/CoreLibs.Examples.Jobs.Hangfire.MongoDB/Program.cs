...
using CoreLibs.Examples.Jobs.Hangfire.MongoDB;
...
builder.Host.UseCoreSerilog(o =>
{
    ...
    o.ApplicationName = "CoreLibs.Examples.Jobs.Hangfire.MongoDB";
});
...
{
    c.SwaggerDoc("v1", new() { Title = "CoreLibs Jobs — Hangfire + MongoDB", Version = "v1" });
});
