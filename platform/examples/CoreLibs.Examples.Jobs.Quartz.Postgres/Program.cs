...
using CoreLibs.Examples.Jobs.Quartz.Postgres;
...
builder.Host.UseCoreSerilog(o =>
{
    ...
    o.ApplicationName = "CoreLibs.Examples.Jobs.Quartz.Postgres";
});
...
{
    c.SwaggerDoc("v1", new() { Title = "CoreLibs Jobs — Quartz + Postgres", Version = "v1" });
});
