...
using CoreLibs.Examples.Jobs.Quartz.MongoDB;
...
builder.Host.UseCoreSerilog(o =>
{
    ...
    o.ApplicationName = "CoreLibs.Examples.Jobs.Quartz.MongoDB";
});
...
{
    c.SwaggerDoc("v1", new() { Title = "CoreLibs Jobs — Quartz + MongoDB", Version = "v1" });
});
