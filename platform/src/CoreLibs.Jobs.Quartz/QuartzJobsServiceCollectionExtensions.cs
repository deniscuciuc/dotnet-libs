...
{
    /// <summary>
    /// Registers Quartz.NET as the CoreLibs.Platform job scheduling provider.
...
/// <summary>
/// Registers the <see cref="CoreQuartzJobListener"/> with the Quartz scheduler when initialized.
/// </summary>
internal sealed class QuartzListenerRegistrar(
    ISchedulerFactory schedulerFactory,
    CoreQuartzJobListener jobListener) : ISchedulerListener
{
