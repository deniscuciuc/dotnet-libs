    ...
    ILogger<QuartzJobScheduler> logger) : IJobScheduler
{
    ...
    public async Task EnqueueAsync<TJob>(CancellationToken ct) where TJob : ICoreJob
    {
    ...
    public async Task EnqueueAsync<TJob>(object args, CancellationToken ct) where TJob : ICoreJob
    {
    ...
    public async Task ScheduleAsync<TJob>(TimeSpan delay, CancellationToken ct) where TJob : ICoreJob
    {
    ...
    public async Task ScheduleAsync<TJob>(object args, TimeSpan delay, CancellationToken ct) where TJob : ICoreJob
    {
    ...
    private static IJobDetail CreateJobDetail<TJob>(string identity, object? args = null) where TJob : ICoreJob
    {
