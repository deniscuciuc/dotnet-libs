...
public static class PostgresServiceCollectionExtensions
{
    ...
    /// <see cref="DomainExtensions.AddCoreDomainEvents"/> has been called.
    /// </summary>
    public static IServiceCollection AddCorePostgres<TContext>(
        ...
        where TContext : DbContext
    {
        ...
        {
            ConfigureNpgsql(dbOptions, options, configureDataSource, configureNpgsql);
