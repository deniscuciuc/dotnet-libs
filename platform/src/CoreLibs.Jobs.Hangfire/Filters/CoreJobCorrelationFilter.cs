...
/// </summary>
internal sealed class CoreJobCorrelationFilter : JobFilterAttribute, IClientFilter, IServerFilter
{
    private const string CorrelationIdKey = "CoreLibs-CorrelationId";
    private const string TraceIdKey = "CoreLibs-TraceId";
    ...
    public void OnPerforming(PerformingContext context)
    {
        ...
        if (!string.IsNullOrEmpty(correlationId))
        {
            ...
            Activity.Current?.SetTag("corelibs.correlation_id", correlationId);
