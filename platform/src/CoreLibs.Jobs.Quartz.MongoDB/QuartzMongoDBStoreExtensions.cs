...
namespace CoreLibs.Jobs.Quartz.MongoDB;
...
public static class QuartzMongoDBStoreExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<IQuartzMongoDbJobStoreFactory>(
            _ => new CoreQuartzMongoDbJobStoreFactory(connectionString, databaseName));
...
/// </summary>
internal sealed class CoreQuartzMongoDbJobStoreFactory : IQuartzMongoDbJobStoreFactory
{
    private readonly IMongoDatabase _database;

    public CoreQuartzMongoDbJobStoreFactory(string connectionString, string databaseName)
    {
