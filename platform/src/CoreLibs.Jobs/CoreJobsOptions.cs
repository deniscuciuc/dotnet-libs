...
/// <summary>
/// Configuration options for the CoreLibs.Platform job scheduling system.
/// Bound from the <c>Jobs</c> configuration section.
/// </summary>
public sealed class CoreJobsOptions
{
    ...
    public CoreJobsDashboardOptions Dashboard { get; set; } = new();
}

/// <summary>
/// Dashboard configuration options.
/// </summary>
public sealed class CoreJobsDashboardOptions
{
...
{
    /// <summary>Use CoreLibs.Identity claims-based auth.</summary>
    Identity,
