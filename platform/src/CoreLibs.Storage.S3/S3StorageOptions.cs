...
public sealed class S3StorageOptions
{
    ...
    /// <summary>
    /// Whether to use HTTP instead of HTTPS when connecting to the S3 endpoint.
    /// </summary>
    public bool UseHttp => Endpoint.StartsWith("http://", StringComparison.OrdinalIgnoreCase);
