...
public static class CorrelationIdExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddPlatformCorrelationId(this IServiceCollection services)
    {
    ...
    /// Place this before <c>UsePlatformRequestLogging()</c> and <c>UseAuthentication()</c>.
    /// </summary>
    public static IApplicationBuilder UsePlatformCorrelationId(
