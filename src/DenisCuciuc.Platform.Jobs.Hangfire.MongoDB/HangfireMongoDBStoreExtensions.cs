...
namespace DenisCuciuc.Platform.Jobs.Hangfire.MongoDB;
...
public static class HangfireMongoDBStoreExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        var queueStrategy = configuration.GetSection(PlatformJobsOptions.DefaultSectionPath)["mongoCheckQueuedJobsStrategy"] switch
        {
