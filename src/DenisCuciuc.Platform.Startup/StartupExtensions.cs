...
public static class StartupExtensions
{
    ...
    public static IServiceCollection AddPlatformStartupGuard<T>(this IServiceCollection services)
    {
    ...
    public static IServiceCollection AddPlatformStartup<T>(this IServiceCollection services)
    ...
    /// </summary>
    public static IServiceCollection AddPlatformStartupTasksFromAssemblyOf<TMarker>(this IServiceCollection services)
    {
    ...
    private sealed class HostStartupImpl : IHostStartup
    {
        public HostStartupImpl(IHost application)
        {
            ...
            Logger = Services.GetRequiredService<ILoggerFactory>().CreateLogger("DenisCuciuc.Platform.Startup");
        }
