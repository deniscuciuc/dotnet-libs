...
using DenisCuciuc.Platform.Examples.Jobs.Hangfire.MongoDB;
...
builder.Host.UsePlatformSerilog(o =>
{
    ...
    o.ApplicationName = "DenisCuciuc.Platform.Examples.Jobs.Hangfire.MongoDB";
});
...
// Provider and store are driven by appsettings.yml: provider=hangfire, store=mongodb
...
{
    c.SwaggerDoc("v1", new() { Title = "DenisCuciuc.Platform Jobs â€” Hangfire + MongoDB", Version = "v1" });
});
