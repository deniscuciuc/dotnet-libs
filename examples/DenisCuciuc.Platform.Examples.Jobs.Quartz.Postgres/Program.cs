...
using DenisCuciuc.Platform.Examples.Jobs.Quartz.Postgres;
...
builder.Host.UsePlatformSerilog(o =>
{
    ...
    o.ApplicationName = "DenisCuciuc.Platform.Examples.Jobs.Quartz.Postgres";
});
...
// Provider and store are driven by appsettings.yml: provider=quartz, store=postgres
...
{
    c.SwaggerDoc("v1", new() { Title = "DenisCuciuc.Platform Jobs â€” Quartz + Postgres", Version = "v1" });
});
...
// Note: Quartz does not have a built-in dashboard; use /swagger to explore the API.
