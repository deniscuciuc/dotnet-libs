...
using DenisCuciuc.Platform.Examples.Jobs.Hangfire.Postgres;
...
builder.Host.UsePlatformSerilog(o =>
{
    ...
    o.ApplicationName = "DenisCuciuc.Platform.Examples.Jobs.Hangfire.Postgres";
});
...
// Provider and store are driven by appsettings.yml: provider=hangfire, store=postgres
...
{
    c.SwaggerDoc("v1", new() { Title = "DenisCuciuc.Platform Jobs â€” Hangfire + Postgres", Version = "v1" });
});
