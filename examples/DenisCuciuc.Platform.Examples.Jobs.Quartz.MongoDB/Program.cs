...
using DenisCuciuc.Platform.Examples.Jobs.Quartz.MongoDB;
...
builder.Host.UsePlatformSerilog(o =>
{
    ...
    o.ApplicationName = "DenisCuciuc.Platform.Examples.Jobs.Quartz.MongoDB";
});
...
// Provider and store are driven by appsettings.yml: provider=quartz, store=mongodb
...
{
    c.SwaggerDoc("v1", new() { Title = "DenisCuciuc.Platform Jobs â€” Quartz + MongoDB", Version = "v1" });
});
